...
Password:
      ...
      style={{color:'#0B885B', borderColor:'#0B885B', borderRadius: '8px',width:'120px'}}>Delete</Button>
      <Button variant="outlined"
      style={{color:'#0B885B', borderColor:'#0B885B', borderRadius: '8px',width:'120px'}}>Edit</Button>
    </Stack>
